/* ═══════════════════════════════════════════════════════════
   FILL PROTOCOL — Typewriter Effect
   Cycles through taglines with typing animation.
   ═══════════════════════════════════════════════════════════ */

const TAGLINES = [
  '> claim creator fees → open AAPL perp 50x',
  '> profit → buyback + burn token',
  '> no vaults · no deposits · no KYC',
  '> autonomous engine, on-chain forever',
];
